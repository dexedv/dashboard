...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn('rounded-xl border border-border/50 bg-card/80 backdrop-blur-sm text-card-foreground shadow-lg shadow-black/5 transition-all duration-200 hover:shadow-xl hover:shadow-black/10', className), ...props })));
